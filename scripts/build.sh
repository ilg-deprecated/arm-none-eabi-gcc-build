...
cp "${script_folder_path}"/*.sh "${HOST_WORK_FOLDER_PATH}/scripts"
cp "${script_folder_path}"/helper/container-functions-source.sh "${HOST_WORK_FOLDER_PATH}/scripts/helper"
cp "${script_folder_path}"/helper/host-functions-source.sh "${HOST_WORK_FOLDER_PATH}/scripts/helper"
